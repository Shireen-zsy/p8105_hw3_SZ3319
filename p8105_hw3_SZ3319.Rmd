...
p1 is not fancy and is hard to 
so, create p2
...
ide_duration_plot <- ggplot(ride_duration, aes(x = weekdays, y = median_duration, fill = month)) +
  geom_bar(stat = "identity", position = "dodge") +  # 使用条形图
  facet_wrap(~ year) +  # 按年份分面
  labs(title = "Median Ride Duration by Day of the Week and Month",
       x = "Day of the Week",
